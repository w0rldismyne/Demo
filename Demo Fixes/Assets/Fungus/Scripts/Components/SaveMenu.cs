...
namespace Fungus
{
    ...
    public class SaveMenu : MonoBehaviour 
    {
        ...
        public virtual void Save(int id)
        {
            ...
            {
                PlayClickSound();
                saveManager.Save(saveDataKey + "_" + id.ToString());
            }
        }
        ...
        public virtual void Load(int id)
        {
            ...
            if (saveManager.SaveDataExists(saveDataKey + "_" + id.ToString()))
            {
                PlayClickSound();
                saveManager.Load(saveDataKey + "_" + id.ToString());
            }
        ...
        public void Delete(int id) {
            ...
            PlayClickSound();
            saveManager.Delete(saveDataKey + "_" + id.ToString());
        }
